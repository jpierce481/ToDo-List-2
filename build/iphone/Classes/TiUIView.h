...
/**
 Base class for all SimpleToDo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SimpleToDo view hierarchy (such as wrapped iOS UIViews) was touched.
