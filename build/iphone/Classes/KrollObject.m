 ...
 * Copyright (c) 2009-2011 by SimpleToDo, Inc. All Rights Reserved.
...
//@interface SimpleToDoObject : NSObject
//@end

@interface SimpleToDoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SimpleToDoObject class]])
		{
			for (NSString *key in [[(SimpleToDoObject*)o modules] allKeys])
			{
