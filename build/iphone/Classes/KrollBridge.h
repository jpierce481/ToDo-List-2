...
@interface SimpleToDoObject : KrollCoverageObject {
#else
@interface SimpleToDoObject : KrollObject {
#endif
@private
...
extern NSString * SimpleToDo$ModuleRequireFormat;
