...
// in simulator we redefine to format for SimpleToDo Developer console
...
{\
	NSString * exceptionName = [@"org.simpletodo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.simpletodo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISimpleToDoNativeItemNone = -1, 
	UISimpleToDoNativeItemSpinner = -2,
	UISimpleToDoNativeItemProgressBar = -3,
	
	UISimpleToDoNativeItemSlider = -4,
	UISimpleToDoNativeItemSwitch = -5,
	UISimpleToDoNativeItemMultiButton = -6,
	UISimpleToDoNativeItemSegmented = -7,
	
	UISimpleToDoNativeItemTextView = -8,
	UISimpleToDoNativeItemTextField = -9,
	UISimpleToDoNativeItemSearchBar = -10,
	
	UISimpleToDoNativeItemPicker = -11,
	UISimpleToDoNativeItemDatePicker = -12,
	
	UISimpleToDoNativeItemInfoLight = -13,
	UISimpleToDoNativeItemInfoDark = -14,
	
	UISimpleToDoNativeItemDisclosure = -15,
	
	UISimpleToDoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SimpleToDo instances of
